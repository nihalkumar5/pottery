...
const MOCK_PRODUCTS = [
  ...
  { id: 3, name: 'Terracotta Goblet Cup', category: 'Drinkware', price: 699.00, description: 'Elegant handcrafted goblet inspired by traditional Indian pottery. Suitable for serving tea, coffee, lassi, and festive beverages.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 4, name: 'Artisan Clay Glass', category: 'Drinkware', price: 399.00, description: 'Minimal handcrafted clay tumbler for water, juice, chaas, and traditional drinks.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 5, name: 'Hand-Painted Terracotta Water Bottle', category: 'Water Bottles', price: 999.00, description: 'Beautiful hand-painted terracotta bottle designed for naturally cool drinking water while adding artistic charm.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 6, name: 'Leaf Carved Terracotta Bottle', category: 'Water Bottles', price: 899.00, description: 'Handmade engraved clay bottle featuring elegant leaf carvings and natural cooling properties.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 7, name: 'Classic Terracotta Bottle', category: 'Water Bottles', price: 699.00, description: 'Minimal handcrafted earthen bottle designed for everyday hydration with natural cooling.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 8, name: 'Hand-Painted Water Dispenser', category: 'Water Storage', price: 2999.00, description: 'Traditional hand-painted terracotta water dispenser with tap, combining artisan craftsmanship and functional design.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 9, name: 'Heritage Terracotta Jug', category: 'Serveware', price: 1199.00, description: 'Rustic handcrafted clay jug for serving water, lemonade, chaas, and other beverages.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 10, name: 'Artisan Serving Set', category: 'Serveware', price: 1499.00, description: 'Complete handcrafted serving set including tray, bowls, and serving accessories for snacks and festive gatherings.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 11, name: 'Hand-Painted Decorative Vase', category: 'Home Decor', price: 1299.00, description: 'Elegant hand-painted terracotta vase crafted to complement modern and traditional interiors.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 12, name: 'Decorative Terracotta Vase', category: 'Home Decor', price: 999.00, description: 'Minimal artisan vase with timeless earthy aesthetics for fresh flowers or dried arrangements.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' },
  { id: 13, name: 'Temple Bell', category: 'Spiritual Collection', price: 499.00, description: 'Handmade terracotta temple bell crafted for home temples and spiritual décor with a traditional finish.', features: ['Handmade', 'Food Safe', 'Natural Clay', 'Eco-Friendly', 'Reusable'], image: '/assets/vase.png' }
];
